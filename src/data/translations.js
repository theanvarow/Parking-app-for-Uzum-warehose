...
export const translations = {
  uz: {
    ...
    actInputPlaceholder: 'Korob kodini uring (80-000056560)',
    actPrefixError: 'Noto\'g\'ri korob kodi! Kod 80- bilan boshlanishi shart!',
  ...
  ru: {
    ...
    actInputPlaceholder: 'Введите код короба (80-000056560)',
    actPrefixError: 'Неверный код короба! Код должен начинаться с 80-',
